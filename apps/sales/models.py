...
class SalesRecord(models.Model):
    ...
    create_time = models.DateTimeField(default=datetime.now, verbose_name="创建时间", help_text="创建时间", null=True,
                                       blank=True)
    retail_sales = models.IntegerField(default=0, blank=True, verbose_name="零售销量", help_text="零售销量")
    retail_price = models.FloatField(default=0, blank=True, verbose_name="实际零售金额", help_text="实际零售金额")
    project_sales = models.IntegerField(default=0, blank=True, verbose_name="工程销量", help_text="工程销量")
    project_price = models.FloatField(default=0, blank=True, verbose_name="实际工程金额", help_text="实际工程金额")
    wholesale_sales = models.IntegerField(default=0, blank=True, verbose_name="批发销量", help_text="批发销量")
    wholesale_price = models.FloatField(default=0, blank=True, verbose_name="实际批发金额", help_text="实际批发金额")
    online_sales = models.IntegerField(default=0, blank=True, verbose_name="电商销量", help_text="电商销量")
    online_price = models.FloatField(default=0, blank=True, verbose_name="实际电商金额", help_text="实际电商金额")
