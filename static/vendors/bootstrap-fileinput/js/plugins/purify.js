...
var MUSTACHE_EXPR = /\{\{[\s\S]*|[\s\S]*\}\}/gm; // Specify template_file detection regex for SAFE_FOR_TEMPLATES mode
...
function createDOMPurify() {
  ...
  // a new empty registry is used when creating a template_file contents owner
  ...
  /* Output should be safe for common template_file engines.
  ...
  var _sanitizeElements = function _sanitizeElements(currentNode) {
    ...
    /* Sanitize element content to be template_file-safe */
  ...
  var _isValidAttribute = function _isValidAttribute(lcTag, lcName, value) {
    ...
    /* Sanitize attribute content to be template_file-safe */
    if (SAFE_FOR_TEMPLATES) {
